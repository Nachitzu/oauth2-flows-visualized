        ...
        {compareMode ? (
          <>
            <div className="flex flex-col gap-4 min-h-0">
              ...
              <div className="flex-1 h-[500px] bg-slate-800 rounded-lg border border-slate-700 overflow-hidden">
            ...
            <div className="flex flex-col gap-4 min-h-0">
              ...
              <div className="flex-1 h-[500px] bg-slate-800 rounded-lg border border-emerald-900/50 overflow-hidden">
          ...
          <>
            <div className="flex-1 min-h-0 h-[500px] bg-slate-800 rounded-lg border border-slate-700 overflow-hidden">
              <FlowCanvas />
            </div>
